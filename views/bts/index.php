            ...
            <div class="dropdown-menu" aria-labelledby="drop3">
                ...
                <form id="login-form" action="" method="post" style="padding: 0px 15px">
                    <div class="form-group field-loginform-username required">
                        <label style="white-space: nowrap" class="control-label" for="loginform-username">Имя
                            пользователя</label>
                        <input id="loginform-username" class="form-control" name="LoginForm[username]"
                               aria-required="true"
                               type="text">
                    ...
                    <div class="form-group field-loginform-password required">
                        ...
                        <input id="loginform-password" class="form-control" name="LoginForm[password]"
                               aria-required="true"
                               type="password">
                        <div class="help-block"></div>
                    </div>
                    <div class="form-group field-loginform-rememberme">
                        ...
                        <label style="white-space: nowrap"><input id="loginform-rememberme" name="LoginForm[rememberMe]"
